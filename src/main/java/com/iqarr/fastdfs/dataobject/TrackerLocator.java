...
import com.iqarr.fastdfs.exception.FdfsUnAvailableException;

import static com.iqarr.fastdfs.constants.FastdfsSystemConstants.*;
/**
* Tracker服务器位置
*   <pre>
* 支持负载均衡对IP轮询
...
public class TrackerLocator {
    ...
    /** 连接中断以后经过N秒重试 */
    private int retryAfterSecend = DEFAULT_TRACKER_RETRY_AFTER_SECEND;
