 ...
 * param对象与byte映射器
* @Title:
*	 	FdfsParamMapperFactory.java
* @Package 
*		com.iqarr.fastdfs.mapperfactory
* @ClassName: 
*		FdfsParamMapperFactory  
* @since 
*	  V1.0
* @author 
*		zhangyong   
...
*		V1.0
 */
public class FdfsParamMapperFactory {

    private FdfsParamMapperFactory() {
        // hide for utils
    }
    ...
    /** 日志 */
    private static Logger LOGGER = LoggerFactory.getLogger(FdfsParamMapperFactory.class);
